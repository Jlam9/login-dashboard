        ...
        <div>
          ...
          <div className="table-responsive px-md-4 px-2 pt-3">
            <form action="" method="post">
              <div className="mb-3">
                <img src="https://images.pexels.com/photos/7322083/pexels-photo-7322083.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" class="w-25 h-auto rounded mx-auto d-block" alt="product" />
              </div>
              <div className="mb-3">
